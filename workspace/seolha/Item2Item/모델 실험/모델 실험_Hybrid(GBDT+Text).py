...
train_df = spark.table("hive_metastore.dimension_reduce.cosine_similarity_51_train_drop")
...
columns_to_select = [
    ...
    "max_cosine_similarity", "min_cosine_similarity", "mean_cosine_similarity", 
    "std_dev_cosine_similarity", "skewness_cosine_similarity", "kurtosis_cosine_similarity",
...
plt.ylabel('Feature')
plt.title('Feature Importances_GBDT+Text')
