...
# feature importance 뽑을 수 있는 ver.
...
def train_random_forest_with_undersampling5(train_df):
    # 라벨링 기준 설정
...
# 모델 학습 및 평가
model, feature_columns, val_auc, precision, recall, f1_score = train_random_forest_with_undersampling5(selected_df)
